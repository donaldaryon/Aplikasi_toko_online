@extends('user.app')
@section('content')
<div class="site-blocks-cover"  style="background-image: url({{ asset('shopper') }}/images/hero_1b.jpg);" data-aos="fade">
  
<div class="container">
    <div class="row align-items-start align-items-md-center justify-content-end">
        <div class="col-md-3 text-center text-md-left pt-3 pt-md-0">
        <h1 class="mb-6 ">Cari kebutuhan oleh - oleh khas Kabupaten Timor Tengah Selatan - NTT, ada Di Sini</h1>
        <div class="intro-text text-center text-md-left">
            <p class="mb-4">Kain Tenun disini terjamin kualitasnya dan tentunya barangnya juga original bukan kw. </p>
            <p>
