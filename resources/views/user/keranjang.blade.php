        ...
        @csrf
            ...
            <tbody>
                ...
                <td>
                    ...
                    <input type="hidden" value="{{ $keranjang->stok }}" id="number">
                    <input type="hidden" name="id[]" value="{{ $keranjang->id }}">
                    <input type="text" name="qty[]" class="form-control text-center" id="numberPlace" placeholder="" aria-label="Example text with button addon" aria-describedby="button-addon1" value="{{ $keranjang->qty }}" readonly>
                    ...
                    <script>
                        ...
                        var minusBtn = document.getElementById("minus"),
                            ...
                            number = {{ $keranjang->qty }}, /// number value
                            min = 0, /// min number
                            max = {{ $keranjang->stok }}; /// max number
