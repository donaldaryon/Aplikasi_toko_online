        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row  mb-4">
                        <div class="col-md-12 text-center">
                            Transfer Sebesar <b>Rp {{ number_format($order->subtotal,2,',','.') }}</b> Ke No Rekening Di Atas
                            <div>
                            <p class="text-danger">
                                <small>Jika Transaksi Lewat Dari 12 Jam, Maka Transaksi Tidak Akan Di Proses.</p></small>
                        </div>
                        </div>
                    </div>
                    <hr>
