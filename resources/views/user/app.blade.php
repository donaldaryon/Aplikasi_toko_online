...
<html lang="en">
  <head>
    <title>Toko Cendana &mdash; Toko Online </title>
    <meta charset="utf-8">
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <h1><a href="/" class="js-logo-clone">Toko Cendana</a></h1>
              </div>
            </div>
          ...
          <div class="col-md-6 col-lg-6">
            <div class="block-5 mb-5">
              ...
              <ul class="list-unstyled">
                ...
                <li class="address">So'e,Timor Tengah Selatan,Nusa Tenggara Timur (NTT)</li>
                <li class="phone"><a href="tel://23923929210">+62 852 3613 5592</a></li>
                <li class="email">AdminTokoCendana@gmail.com</li>
              </ul>
            </div>
